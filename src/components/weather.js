        ...
        <div>
            ...
            <div className="col-md-10 offset-md-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <p>{props.precipitation && <p>Precipitation in mm: {props.precipitation}</p>}</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <p>{props.forecast_precipitation[0] && <p>Precipitation in mm : {props.forecast_precipitation[0]}</p>}</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <p>{props.forecast_precipitation[1] && <p>Precipitation in mm : {props.forecast_precipitation[1]}</p>}</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <p>{props.forecast_precipitation[2] && <p>Precipitation in mm : {props.forecast_precipitation[2]}</p>}</p>
                    </div>
