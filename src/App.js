  ...
  getWeather= async(e)=>{
    ...
    e.preventDefault();
      ...
      while(counter<=3){
          ...
          forecast_precipitation.push(forecast_response.forecast.forecastday[counter].day.totalprecip_mm);
          counter++;
      }
      ...
      while(days>1){
          ...
          precipitation.push(result.forecast.forecastday[0].day.totalprecip_mm);
          days--;
      }
      ...
      if(city && country){
          ...
          this.setState({
              ...
              precipitation: forecast_response.current.precip_mm,
              error: "",
    ...
    return (
      <div>
        ...
        <Weather
            ...
            forecast_precipitation={this.state.forecast_precipitation}/>

          <Chart
              chartDataTemperature={this.state.chartDataTemperature}
              chartDataHumidity={this.state.chartDataHumidity}
              chartDataPrecipitation={this.state.chartDataPrecipitation}
          />
